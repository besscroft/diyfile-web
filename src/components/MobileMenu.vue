  ...
  <n-space class="flex justify-center items-center justify-space-around">
    <n-dropdown trigger="hover" :options="settingOptions" @select="handleSelect">
      <n-button icon-placement="left" quaternary>
        ...
        <p :class="activeItem.startsWith('/@admin/setting') ? 'text-green-600' : 'text-black'">{{ t('menu.setting.index') }}</p>
      </n-button>
    </n-dropdown>
    <n-button icon-placement="left" quaternary @click="routerPage('/@admin')">
      ...
      <p :class="activeItem.startsWith('/@admin') ? 'text-green-600' : 'text-black'">{{ t('menu.index') }}</p>
    </n-button>
    <n-dropdown trigger="hover" :options="systemOptions" @select="handleSelect">
      <n-button icon-placement="left" quaternary>
        ...
        <p :class="activeItem.startsWith('/@admin/system') ? 'text-green-600' : 'text-black'">{{ t('menu.system.index') }}</p>
      </n-button>
    </n-dropdown>
  </n-space>
</template>
